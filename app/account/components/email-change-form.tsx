...
export default function EmailChangeForm({ email }: { email: string }) {
    ...
    const handleSubmit = async (e: SubmitEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            toast.success(
                `If ${validatedEmail} is available, we've sent a confirmation link to ${email} to continue the change. If nothing arrives within a few minutes, that address may already be in use.`,
                {
                    position: "top-center",
                },
            )
        ...
        <section className="mt-6 space-y-4">
            ...
            <Card className="max-w-1/2">
                        ...
                        <FieldSet className="space-y-2">
                            <FieldGroup>
                                ...
                                <Field>
                                    ...
                                    />
                                    <FieldDescription>
                                        Confirm your new email address. A confirmation email will be sent to your
                                        current address; once confirmed, a second email will be sent to your new address
                ...
                <CardFooter className="justify-end gap-2">
                    <Button type="submit" form="email-change-form" disabled={isUpdating || !emailChanged}>
